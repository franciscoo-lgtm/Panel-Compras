    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => onContinue(photos)} className="px-3 py-1.5 rounded-md text-[11px] font-medium bg-[#31AF4F] hover:bg-[#31AF4F]/85 text-white inline-flex items-center gap-1.5">
